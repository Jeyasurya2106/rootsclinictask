    ...
    <footer className="bg-gray-900 text-white pt-12 pb-6">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div>
            ...
            <div className="space-y-2 text-gray-400">
              <p className="flex items-center">
                ...
                <a href="tel:+917068706821" className="hover:text-teal-400 transition">
                  +91-7068 7068 21
                </a>
              </p>
              <p className="flex items-center">
                ...
                <a href="mailto:rootsclinicforwomen@gmail.com" className="hover:text-teal-400 transition">
          ...
          <div>
            ...
            <div className="flex space-x-4">
              <a 
                ...
                className="bg-teal-600 p-3 rounded-full hover:bg-teal-500 transition"
              >
        ...
        <div className="border-t border-gray-800 pt-6 text-center text-gray-400 text-sm">
          <p>Copyright © Computervalley IT Solutions Pvt Ltd. All rights reserved</p>
        </div>
      </div>
    </footer>
  );
